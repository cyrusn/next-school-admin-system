...
export const columns = [
  ...
  { title: '總分', name: 'mark', data: 'mark' },
  { title: '操行', name: 'grade', data: 'grade' },
  { title: '優點', name: 'merit', data: 'merit' },
  { title: '小功', name: 'minorCredit', data: 'minorCredit' },
  { title: '大功', name: 'majorCredit', data: 'majorCredit' },
  { title: '缺點', name: 'demerit', data: 'demerit' },
  {
    title: '小過',
